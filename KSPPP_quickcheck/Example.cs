...
//			}).QuickCheck();
		...
		public class ArbitraryLong : Arbitrary<long> {
			public override Gen<long> Generator {
				get { 
					return (Gen<long>)Any.OfSize (s => Any.IntBetween (-s, s))
										 .Select (i => Convert.ToInt64 (i)); 
				}
			}
		}
//		public class ArbitraryByte : Arbitrary<byte> {
//			public override Gen<byte> Generator {
//				get { 
//					return (Gen<byte>) Any.OfSize (s => Any.IntBetween (-s, s)).Select (i => Convert.ToInt64 (i)); 
//				}
//			}
//		}
		...
		{
			//public static Arbitrary<byte>			Byte()			{ return ArbitraryByte(); }
